...
- Recruited on 05/23/22, 31 participants
...
Exclusions computed 05/26/22

Total n = 79

1. filter out people who don't get all 4 qualtics attention correct (5 people, n = 74)
2. filter people who dont pass 14/16 threshold for EAEA questions (17 people, n = 57)
3. filter people who didn't move the slider bar for at least 1 video (2 people, n = 55)
4. filter people who didn't complete digit span task (1 person, n = 54)
5. filter people who have digit span forward score greater than 2 sds of the mean (4, n = 50)
6. filter people who have digit span reverse score greater than 2 sds of the mean (1, n = 49)
...
```{r calculate average Empathic Accuracy, eval = TRUE, echo = FALSE, include = FALSE}
#attach(dat)
...
```{r distribution of key variables, eval = TRUE, message=FALSE, warning = FALSE, echo = FALSE}
# distribution of adversity measures, aggression, and antisocial measures   ###
...
## Distribution of Adversity Variables

```{r r distribution of adversity variables, message=FALSE, warning = FALSE, echo = FALSE, eval = TRUE}

#### distribution of adversity measures only   ####
...
```{r correlation matrix w p values, eval = FALSE, include = FALSE}
corr <- dat %>% select(
    IRI_total,
    BPAQ_Hostility,
    SRDS_total,
...
```{r summary of correlations text, eval = FALSE, include = FALSE}
...
```{r initial linear models, eval = FALSE, include = FALSE}
...
```{r MSSD Analysis, eval = FALSE, include = FALSE}
